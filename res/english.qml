...
Language {
    ...
    function hours_00(enable, isAM) { //"IT IS _ TWELVE _"
        it_is(enable)
    ...
    function hours_04(enable, isAM) { //IT IS _ FOUR _"
        it_is(enable)
    ...
    function hours_05(enable, isAM) { //"IT IS _ FIVE _"
        it_is(enable)
    ...
    function hours_06(enable, isAM) { //"IT IS _ SIX _"
        it_is(enable)
        tmp_onoff_table[8][0] = enable
        tmp_onoff_table[8][1] = enable
        tmp_onoff_table[8][2] = enable
    }
    function hours_07(enable, isAM) { //"IT IS _ SEVEN _"
        it_is(enable)
    ...
    function hours_08(enable, isAM) { //"IT IS _ EIGHT _"
        it_is(enable)
    ...
    function hours_09(enable, isAM) { //"IT IS _ NINE _"
        it_is(enable)
    ...
    function hours_10(enable, isAM) { //"IT IS _ TEN _"
        it_is(enable)
        tmp_onoff_table[7][0] = enable
        tmp_onoff_table[7][1] = enable
        tmp_onoff_table[7][2] = enable
    }
    function hours_11(enable, isAM) { //"IT IS _ ELEVEN _"
        it_is(enable)
