...
class Object
{
    ...
    updateTable()
    {
        ...
        let notify = instance.speech_enabled && (((instance.minutes_value % instance.speech_frequency) === 0)
                                                 || firstTime);
        if (notify)
        {
            DeviceAccess.managers.speech.say(instance.written_time);
        ...
        if (isDebug)
        {
            console.debug("%1\t %2 %3".arg(notify ? "♫" : "").arg(instance.time).arg(instance.written_time));
        }
