...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 10340224,
    DYNAMIC_BASE = 15583104,
    DYNAMICTOP_PTR = 10340048;
...
var ASM_CONSTS = {
 ...
 10051: function() {return document.fullscreenEnabled;},  
 10165: function() {if (document.fullscreenElement) document.exitFullscreen().then(toggleFullScreenCallBack); else document.documentElement.requestFullscreen().then(toggleFullScreenCallBack);},  
 10912: function() {return typeof speechSynthesis !== 'undefined'},  
 10962: function($0, $1) {const synth = window.speechSynthesis; synth.cancel(); const voiceIndex = $0; const textToSay = UTF8ToString($1); const utterance = new SpeechSynthesisUtterance(textToSay); var voice = synth.getVoices()[voiceIndex]; utterance.lang = voice.lang; utterance.voice = voice; synth.speak(utterance);},  
 11262: function() {if ('speechSynthesis' in window) { processVoices(); window.speechSynthesis.onvoiceschanged = () => processVoices(); } else { Module._disableSpeechManager(); }}
};
...
// STATICTOP = STATIC_BASE + 10339200;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=10340208;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=10340064;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 10340112, 4), 10340112);
