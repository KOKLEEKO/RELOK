...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 10340480,
    DYNAMIC_BASE = 15583360,
    DYNAMICTOP_PTR = 10340304;
...
var ASM_CONSTS = {
 ...
 10121: function() {return document.fullscreenEnabled;},  
 10160: function() {window.addEventListener('resize', () => getInnerSize()); getInnerSize();},  
 10441: function() {if (document.fullscreenElement) document.exitFullscreen().then(toggleFullScreenCallBack); else document.documentElement.requestFullscreen().then(toggleFullScreenCallBack);},  
 11188: function() {return typeof speechSynthesis !== 'undefined'},  
 11238: function($0, $1) {const synth = window.speechSynthesis; synth.cancel(); const voiceIndex = $0; const textToSay = UTF8ToString($1); const utterance = new SpeechSynthesisUtterance(textToSay); var voice = synth.getVoices()[voiceIndex]; utterance.lang = voice.lang; utterance.voice = voice; synth.speak(utterance);},  
 11538: function() {if ('speechSynthesis' in window) { processVoices(); window.speechSynthesis.onvoiceschanged = () => processVoices(); } else { Module._disableSpeechManager(); }}
};
...
function getInnerSize(){ Module._setSafeInsets(document.body.clientHeight - window.innerHeight, document.body.clientWidth - window.innerWidth); }
...
// STATICTOP = STATIC_BASE + 10339456;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=10340464;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=10340320;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 10340368, 4), 10340368);
...
var _setSafeInsets = Module["_setSafeInsets"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["setSafeInsets"].apply(null, arguments)
};
