...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 10342336,
    DYNAMIC_BASE = 15585216,
    DYNAMICTOP_PTR = 10342160;
...
var wasmBinaryFile = 'WordClock.wasm';
...
var ASM_CONSTS = {
  7497: function() {document.querySelector('#qtspinner').style.display = 'none'; document.querySelector('#qtcanvas').style.display = 'block';},  
 9572: function() {document.addEventListener('visibilitychange', () => { if (Module.wakeLock && document.visibilityState === 'visible') disableAutoLock(); });},  
 9760: function() {if ('getBattery' in navigator) { navigator.getBattery().then((battery) => { Module._updateBatteryLevel(battery.level); battery.addEventListener("levelchange", () => { Module._updateBatteryLevel(battery.level) }); Module._updateIsPlugged(battery.charging); battery.addEventListener("chargingchange", () => { Module._updateIsPlugged(battery.charging) }); }) } else { Module._disableBatteryAndEnergySavingManagers() }},  
 10179: function() {return document.fullscreenEnabled;},  
 10293: function() {if (document.fullscreenElement) document.exitFullscreen().then(toggleFullScreenCallBack); else document.documentElement.requestFullscreen().then(toggleFullScreenCallBack);},  
 11040: function() {return typeof speechSynthesis !== 'undefined'},  
 11090: function($0, $1) {const synth = window.speechSynthesis; synth.cancel(); const voiceIndex = $0; const textToSay = UTF8ToString($1); const utterance = new SpeechSynthesisUtterance(textToSay); var voice = synth.getVoices()[voiceIndex]; utterance.lang = voice.lang; utterance.voice = voice; synth.speak(utterance);},  
 11390: function() {if ('speechSynthesis' in window) { processVoices(); window.speechSynthesis.onvoiceschanged = () => processVoices(); } else { Module._disableSpeechManager(); }}
};
...
function toggleFullScreenCallBack(){ Module._updateIsFullScreen(document.fullscreenElement !== null); }
...
// STATICTOP = STATIC_BASE + 10341312;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=10342320;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=10342176;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 10342224, 4), 10342224);
...
var _setIsAutoLockDisabled = Module["_setIsAutoLockDisabled"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["setIsAutoLockDisabled"].apply(null, arguments)
};

var _updateBatteryLevel = Module["_updateBatteryLevel"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["updateBatteryLevel"].apply(null, arguments)
};

var _updateIsPlugged = Module["_updateIsPlugged"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["updateIsPlugged"].apply(null, arguments)
};

var _disableBatteryAndEnergySavingManagers = Module["_disableBatteryAndEnergySavingManagers"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["disableBatteryAndEnergySavingManagers"].apply(null, arguments)
};

var _updateIsFullScreen = Module["_updateIsFullScreen"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["updateIsFullScreen"].apply(null, arguments)
};

var _disableSpeechManager = Module["_disableSpeechManager"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["disableSpeechManager"].apply(null, arguments)
};

var _clearAll = Module["_clearAll"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["clearAll"].apply(null, arguments)
};

var _isLocaleSupported = Module["_isLocaleSupported"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["isLocaleSupported"].apply(null, arguments)
};

var _processVoice = Module["_processVoice"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["processVoice"].apply(null, arguments)
};

var _notifyLocalesAndVoicesChanged = Module["_notifyLocalesAndVoicesChanged"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["notifyLocalesAndVoicesChanged"].apply(null, arguments)
};
